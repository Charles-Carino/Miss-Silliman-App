...
$sql.="select
  ...
  (('j1_SQ_Total' + 'j2_SQ_Total' + 'j3_SQ_Total' + 'j4_SQ_Total' + 'j5_SQ_Total' + 'j6_SQ_Total' + 'j7_SQ_Total')/7) as 'Average_SQ_Total'
  from
    (select can.id,concat(upper(can.lName),', ',can.fName) candidates
      ,init.judge
      ,col.`collegeCode` cCode
...
$initialScores = DB::select(DB::raw($sql));
  ...
  select
		...
		(((pressLaunch.PL_score * .1) + (((table_pn.AverageProduction*.10) + (table_pn.AverageThemeWr*.25) + (table_pn.AverageEveGown*.25) + (table_pn.AverageSeqIntrvw*.10) + (table_pn.AverageInitIntrvw*.30)) * .6) + ((( table_pre.AverageSpeech * .5 ) + ( table_pre.AverageTalent * .34 ) + ( table_pre.SP * .16 )) * .3)) - (ded1.deduct * 0.01)) totalInitial
	from
		(select
			can.id
  ...
  order by
	...
	from
		(select
				...
				pressLaunch.PL_score as 'pressLaunchScore',
				(( table_pre.AverageSpeech * .5 ) + ( table_pre.AverageTalent * .34 ) + ( table_pre.SP * .16 )) prepageantTotal,
				((table_pn.AverageProduction*.10) + (table_pn.AverageThemeWr*.25) + (table_pn.AverageEveGown*.25) + (table_pn.AverageSeqIntrvw*.10) + (table_pn.AverageInitIntrvw*.30)) pageantNightTotal,
				('pressLaunchScore' * .1)  pressLaunch_tenpercent,
				('prepageantTotal' * .3) prepageant_thirtypercent,
				('pageantNightTotal' * .6) pageantNight_sixtypercent,
				('pressLaunch_tenpercent' + 'prepageant_thirtypercent' + 'pageantNight_sixtypercent') totalInitial
			from
				(select
					can.id
					,concat(upper(can.lName),', ',can.fName) candidates
				...
				(select
						...
						t6.EveGown as 'j6-EveGown',
						t7.EveGown as 'j7-EveGown',
						(('j1-EveGown' + 'j2-EveGown' + 'j3-EveGown' + 'j4-EveGown' + 'j5-EveGown' + 'j6-EveGown' + 'j7-EveGown')/7) as 'AverageEveGown',
						t1.InitIntrvw as 'j1-InitIntrvw',
						t2.InitIntrvw as 'j2-InitIntrvw',
						t3.InitIntrvw as 'j3-InitIntrvw',
						t4.InitIntrvw as 'j4-InitIntrvw',
						...
						t6.InitIntrvw as 'j6-InitIntrvw',
						t7.InitIntrvw as 'j7-InitIntrvw',
						(('j1-InitIntrvw' + 'j2-InitIntrvw' + 'j3-InitIntrvw' + 'j4-InitIntrvw' + 'j5-InitIntrvw' + 'j6-InitIntrvw' + 'j7-InitIntrvw')/7) as 'AverageInitIntrvw',
						t1.Production as 'j1-Production',
						t2.Production as 'j2-Production',
						t3.Production as 'j3-Production',
						t4.Production as 'j4-Production',
						...
						t6.Production as 'j6-Production',
						t7.Production as 'j7-Production',
						(('j1-Production' + 'j2-Production' + 'j3-Production' + 'j4-Production' + 'j5-Production' + 'j6-Production' + 'j7-Production')/7) as 'AverageProduction',
						t1.SeqIntrvw as 'j1-SeqIntrvw',
						t2.SeqIntrvw as 'j2-SeqIntrvw',
						t3.SeqIntrvw as 'j3-SeqIntrvw',
						t4.SeqIntrvw as 'j4-SeqIntrvw',
						...
						t6.SeqIntrvw as 'j6-SeqIntrvw',
						t7.SeqIntrvw as 'j7-SeqIntrvw',
						(('j1-SeqIntrvw' + 'j2-SeqIntrvw' + 'j3-SeqIntrvw' + 'j4-SeqIntrvw' + 'j5-SeqIntrvw' + 'j6-SeqIntrvw' + 'j7-SeqIntrvw')/7) as 'AverageSeqIntrvw',
						t1.ThemeWr as 'j1-ThemeWr',
						t2.ThemeWr as 'j2-ThemeWr',
						t3.ThemeWr as 'j3-ThemeWr',
						t4.ThemeWr as 'j4-ThemeWr',
						...
						t6.ThemeWr as 'j6-ThemeWr',
						t7.ThemeWr as 'j7-ThemeWr',
						(('j1-ThemeWr' + 'j2-ThemeWr' + 'j3-ThemeWr' + 'j4-ThemeWr' + 'j5-ThemeWr' + 'j6-ThemeWr' + 'j7-ThemeWr')/7) as 'AverageThemeWr',
						t1.SQ_Confidence as 'j1-SQ_Confidence',
						t2.SQ_Confidence as 'j2-SQ_Confidence',
						t3.SQ_Confidence as 'j3-SQ_Confidence',
						t4.SQ_Confidence as 'j4-SQ_Confidence',
		...
		where
			pressLaunch.candidates = table_pn.candidates and table_pn.candidates = table_pre.candidates
		) initialScore
		,
		(select
				t0.id,
		...
		where initialScore.candidates = seqQuestion.candidates
	"));
	...
	return view('maintenance.maintenance',compact('judges','organizers','candidates', 'colleges','prepageants','initScores','prePajFinal', 'reports','pressLaunchScores','initialScores','initialScoreSummary','finalScore'));
      }
}
